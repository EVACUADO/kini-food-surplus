    ...
    <Router>
      <div className="min-h-screen bg-gray-50">
        <Routes>
          ...
          {/* Protected Customer and Merchant Dashboard routes */}
          <Route 
          ...
          <Route 
            ...
            element={<ProtectedRoute element={MerchantDashboard} requiredRole="merchant" />} 
          />
          ...
          {/* Protected Admin and Agent Panel routes */}
          <Route 
            path="/AdminPanel" 
